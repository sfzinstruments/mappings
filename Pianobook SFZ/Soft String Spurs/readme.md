SFZ mapping for MTG Trumpet. Use these mappings with Sforzando. Original library programming & samples by Dan Keen. https://www.pianobook.co.uk/library/soft-string-spurs/
